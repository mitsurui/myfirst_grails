...
<html>
	...
	<body>
		...
		<div id="show-testdata" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:testdataInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${testdataInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
